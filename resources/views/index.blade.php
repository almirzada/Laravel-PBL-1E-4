...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <a href="/daftar" class="btn-hero mt-3">Daftar Sekarang</a>
        </div>
    </section>
                ...
                <div class="col-md-4 white">
                    <div class="news-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/detail-badminton" class="read-more">Baca Selengkapnya <i
                ...
                <div class="col-md-4">
                    <div class="news-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/detail-futsal" class="read-more">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="news-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/detail-basket" class="read-more">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
